...
CREATE TABLE IF NOT EXISTS "public"."accounts" (
    ...
    "lang" "public"."lang" DEFAULT 'system'::"public"."lang" NOT NULL,
    "motion" boolean DEFAULT false NOT NULL
);
...
CREATE POLICY "Enable users to view their own data only" ON "public"."accounts" TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "id")) WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "id"));
...
CREATE TRIGGER create_account AFTER INSERT ON auth.users FOR EACH ROW EXECUTE FUNCTION public.create_account();
